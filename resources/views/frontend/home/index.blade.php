					...
					<div class="core-slider_viewport">
						<div class="core-slider_list">
							<div class="core-slider_item">
								<img src="{{ asset('frontend/assets/') }}/{{ asset('frontend/assets/') }}/images/b1.jpg" class="img-responsive" alt="">
							</div>
							 <div class="core-slider_item">
				...
				<div class="new-arrivals-w3agile">
					<div class="container">
						...
						<div class="arrivals-grids">
							...
							<div style="margin-bottom: 2rem" class="col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
									<div  class="grid-arrival">
										<figure>		
											<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
												<div class="grid-img">
													<img style="height: 250px"  src="{{ asset('product/'.$product->image) }}" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													<img style="height: 250px" src="{{ asset('product/'.$product->image) }}" class="img-responsive"  alt="">
												</div>			
									...
									<div class="women">
										...
										<p ><del @if(!$product->discount_price) style="display:none" @endif>${{$product->discount_price}} </del><em class="item_price">${{$product->price}} </em></p>
